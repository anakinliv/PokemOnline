...
public class SetRightsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (rightsStr == null || rightsStr == "")
            return;
        Integer uid = Integer.parseInt(userStr);
        Integer rights = Integer.parseInt(rightsStr);
        Database db = Database.getNewDatabase();
        db.setUserRights(uid.intValue(), rights.intValue());
        Database.databaseAfterUse(db);

        Boolean canChat = (rights.intValue() & User.CHAT_RIGHTS) == User.CHAT_RIGHTS;
        ...
        ((ChatController)obj).setPermit(uid.intValue(), canChat);
    } 
