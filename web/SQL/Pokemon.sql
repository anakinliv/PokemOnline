...
alter table pokemon add constraint FK_Reference_40 foreign key (typeid1)
      references type (typeid) on delete restrict on update restrict;

alter table pokemon add constraint FK_Reference_41 foreign key (typeid2)
      references type (typeid) on delete restrict on update restrict;
